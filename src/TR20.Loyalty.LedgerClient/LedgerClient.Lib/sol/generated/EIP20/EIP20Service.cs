...
namespace TR20.Loyalty.LedgerClient.Contracts.EIP20
{
    public partial class EIP20Service
    {
        ...
        public static async Task<EIP20Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, EIP20Deployment eIP20Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public EIP20Service(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
